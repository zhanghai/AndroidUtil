...
// NOTE: The code below is copied from
 ...
 *
 * <p>The fixes need to be applied via {@link #apply()} before any use of Java Cryptography
 * Architecture primitives. A good place to invoke them is in the
 * {@link android.app.Application#onCreate}.</p>
 */
public final class PRNGFixes {
    ...
    /**
     * Installs a Linux PRNG-backed {@link SecureRandom} implementation as the default. Does nothing
    ...
    /**
     * {@code Provider} of {@link SecureRandom} engines which pass through all requests to the Linux
     * PRNG.
     */
    private static class LinuxPRNGSecureRandomProvider extends Provider {
        ...
        public LinuxPRNGSecureRandomProvider() {
            ...
            // Although /dev/urandom is not a SHA-1 PRNG, some apps explicitly request a SHA1PRNG
            // SecureRandom and we thus need to prevent them from getting the default implementation
            // whose output may have low entropy.
    ...
    public static class LinuxPRNGSecureRandom extends SecureRandomSpi {
        ...
        protected void engineSetSeed(byte[] bytes) {
            try {
                ...
                // On a small fraction of devices /dev/urandom is not writable. Log and ignore.
        ...
        private DataInputStream getUrandomInputStream() {
            synchronized (sLock) {
                if (sUrandomIn == null) {
                    // NOTE: Consider inserting a BufferedInputStream between DataInputStream and
                    // FileInputStream if you need higher PRNG output performance and can live with
                    // future PRNG output being pulled into this process prematurely.
                    try {
    ...
    private static String getDeviceSerialNumber() {
        // We're using the Reflection API because Build.SERIAL is only available since API Level 9
